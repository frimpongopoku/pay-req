...
const REQUESTS = [
  { id: 'REQ-2418', asset: 'a1', title: 'Brake pad + rotor replacement', amount: 1840, currency: 'USD',
    ...
    purpose: 'Front brake pads worn past 3mm — flagged on pre-trip inspection.', payee: 'Eastside Diesel LLC',
    attachments: ['inspection.pdf', 'quote-eastside.pdf', 'pad-photo.jpg'], priority: 'high' },
  { id: 'REQ-2417', asset: 'a3', title: 'DEF system fault — diagnostic + sensor', amount: 920, currency: 'USD',
    ...
    purpose: 'Check engine light, code SPN 3361.', payee: 'Volvo Service NW', attachments: ['fault-code.pdf'], priority: 'med' },
  { id: 'REQ-2416', asset: 'a6', title: 'Reefer compressor recharge', amount: 415, currency: 'USD',
    ...
    purpose: 'Trailer not holding 38°F on long routes.', payee: 'Cold Chain Pros', attachments: ['quote.pdf'], priority: 'med' },
  { id: 'REQ-2415', asset: 'a2', title: 'Side mirror replacement', amount: 245, currency: 'USD',
    ...
    purpose: 'Driver-side mirror clipped at delivery.', payee: 'Sprinter Parts Direct', attachments: ['receipt-1.jpg', 'invoice.pdf'], priority: 'low' },
  { id: 'REQ-2414', asset: 'a5', title: 'Quarterly DOT inspection', amount: 380, currency: 'USD',
    ...
    purpose: 'Scheduled DOT inspection.', payee: 'Truckline Inspections', attachments: ['cert.pdf', 'receipt.pdf'], priority: 'low' },
  { id: 'REQ-2413', asset: 'a1', title: 'Tire rotation + alignment', amount: 280, currency: 'USD',
    ...
    purpose: 'Uneven wear on rear tires.', payee: 'Eastside Diesel LLC', attachments: [], priority: 'low' },
  { id: 'REQ-2412', asset: 'a4', title: 'Windshield chip repair', amount: 95, currency: 'USD',
    ...
    purpose: 'Small chip on driver side.', payee: 'Glass Doctor', attachments: [], priority: 'low' },
  { id: 'REQ-2411', asset: 'a7', title: 'Hydraulic hose replacement', amount: 1120, currency: 'USD',
    ...
    purpose: 'Visible leak on lift hydraulics.', payee: 'TICO Service', attachments: ['photo.jpg', 'quote.pdf'], priority: 'high' },
];

const ACTIVITY = [
  { who: 'Maya Patel',  what: <>moved <b>REQ-2418</b> to <b>Under review</b></>, ts: '4 min ago', tag: 'review' },
  { who: 'Tomás Reyes', what: <>submitted <b>REQ-2418</b> with 3 attachments</>, ts: '1 h ago',  tag: 'submit' },
  { who: 'Slack',       what: <>posted to <b>#fleet-east</b> — new request</>, ts: '1 h ago',    tag: 'slack', avHue: 280 },
  { who: 'Diego Romero',what: <>approved <b>REQ-2417</b></>, ts: '2 h ago', tag: 'approve' },
  { who: 'Aisha Khan',  what: <>uploaded receipts on <b>REQ-2415</b></>, ts: '4 h ago', tag: 'receipt' },
  { who: 'Park Min-jun',what: <>marked <b>REQ-2414</b> as <b>Completed</b></>, ts: 'Yesterday', tag: 'complete' },
];
...
window.AF_DATA = { ASSETS, REQUESTS, ACTIVITY, KPIS };
